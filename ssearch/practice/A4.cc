 ...
 * Если нашелся такой индекс i, что i + z[i] == |s|, значит i является началом
 * суффикса, который совпадает с префиксом длины z[i]. Первый такой суффикс слева
 * отсекает период строки.
 */
